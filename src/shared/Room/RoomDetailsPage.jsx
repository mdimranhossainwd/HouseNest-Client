    ...
    <div className="container mx-auto">
      <div className="mt-8 mb-12">
        <div className="flex items-center justify-between">
          <h3 className="text-3xl font-semibold">{roominfo?.location?.city}</h3>
        ...
        <div>
          ...
          <p className="pt-4">
            ...
            aesthetic, providing a convenient space for books, decorative items,
            or a tray of refreshments. Technological integration is seamlessly
            woven into the roominfo's fabric, with a state-of-the-art
            entertainment center discreetly nestled against one wall. This
            feature includes a large high-definition television, surround sound
            system, and streaming capabilities, ensuring that the roominfo is a
            hub for entertainment and relaxation. The roominfo's versatility is
            further accentuated by flexible lighting options. <br /> <br />
            ...
            and occasions. Intricately chosen art pieces and decor accents adorn
            the walls, contributing to the roominfo's personality and creating
            points of visual interest. The overall design is a testament to the
            thoughtful curation of elements, striking a delicate balance between
            functionality and aesthetics. In conclusion, this living roominfo
            transcends its utilitarian purpose, evolving into a space that
            embodies comfort, style, and adaptability. It stands as a testament
            to the art of interior design, where each element harmonizes to
            create an environment that is not just a roominfo but a curated
            experience.
          </p>
        </div>
